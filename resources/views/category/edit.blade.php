...
@section('content')
      ...
      <div class="row"> 
        <div class="col-md-12 col-lg-12">
            <h3 class="mb-3" id="titles"> Edit Category </h3>
            
                <div class="card">
                    <div class="card-header">
                        <div class="col-md-8 col-lg-10"></div>
                        <div class="col-md-4 col-lg-2">
                            <a href="{{ url('/category') }}" class="btn btn-success btn-sm" id="addbutton" title="Back">
                          ...
                          <div class="col-lg-12">
                              <div class="p-5">
                                <div class="form-outline mb-4 pb-2" >
                                    ...
                                    <input type="text" name="Name" id="Name" value="{{$categories->Name}}" class="form-control form-control-lg" />
                                </div>
